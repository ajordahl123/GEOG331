...
dirR <- "/Users/Ali/Desktop/Colgate!/Environmental\ Data\ Science/GitHub/GEOG331/activity7/data"
...
neural_net_area <- 301363*400
random_forest_area <- 243712*400
difference <- neural_net_area - random_forest_area
...
diff_raster <- abs(nnet_prediction - rf_prediction)
plot(diff_raster)
